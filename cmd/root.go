...
import (
	...
	"github.com/gkwa/curiosturkey/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.curiosturkey.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".curiosturkey")
	}
